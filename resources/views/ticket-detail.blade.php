...
<div class="max-w-md mx-auto py-10">
    ...
    <div class="bg-white rounded-[2.5rem] overflow-hidden shadow-2xl">
        ...
        <!-- Header Ticket -->
        <div
            class="bg-indigo-50 border-b-4 border-dashed border-indigo-100 text-center p-8 relative">
        ...
        <div class="p-8">
            ...
            <!-- QR -->
            <div
                class="mt-8 bg-slate-100 rounded-3xl p-6 flex flex-col items-center">
                ...
                <div
                    class="w-52 h-52 bg-white rounded-2xl shadow-inner flex items-center justify-center">
